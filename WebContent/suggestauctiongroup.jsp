...
<head>
<meta charset="UTF-8">
<title>uBuy Send Feedback</title>
...
<!-- ====================================================
	...
	<div align="center"><h1>Your Feedback Message</h1></div><br><br>
	
	<form action="WriteFeedbackServlet" method="POST">
		<h3>Please enter the name of the Auction Group you would like us to create:</h3>
		<input type="text" name="suggestedAuctionGroupName" required="required"><br>
		<h3>Please explain why we need this Auction Group:</h3>
	...
	<%} // <!-- Ende: if (user!=null && user.isActive()) -->
	else {
