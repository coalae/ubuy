...
<!-- ====================================================
	...
	<div align="center">
	<h1>Your Feedback Message</h1> <br>
	
	<form action="SelectFeedbackServlet" method="POST">
	<h4>What kind of feedback would you like to send to us?</h4>
		<select name="feedbacktype" required="required">
			<option value="feedback">General Feedback</option>
			<option value="auctionGroupSuggestion">Suggest an Auction Group</option>
		</select> <br><br>
		<input type="submit" value="Create Feedback Message">
	</form>
