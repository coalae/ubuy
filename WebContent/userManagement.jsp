...
<head>
	<meta charset="UTF-8">
	<title>uBuy View all Users</title>
				...
				<div class="col-md-7">
					<nav class="navbar navbar-default">
					  <div class="container-fluid nav-bar">
						...
						<li><a class="menu active" href="UserListServlet">User Management</a></li>
...
<h3> Please click on the UserID Hyperlink to view the users account and to edit it.</h3>
<br> 

<% UserManagement umg = new UserManagement();
   ArrayList<User> uList = umg.getUserList();
%>
	
	<table class="table table-striped">
	  <tr>
	  <th><div align="center"><h3>UserID</h3></div></th>
	  	<th><div align="center"><h3>Username</h3></div></th>
	  	<th><div align="center"><h3>FirstName</h3></div></th>
	  	<th><div align="center"><h3>LastName</h3></div></th>
	  	</tr>
	 <%for(int i = 0; i<uList.size(); i++){%>
	  	<tr>
	  		<td><div align="center"><h3><a href="UserListServlet?UUID=<%=uList.get(i).getId()%>"> view this User</a></h3></div> 
	  		<td><div align="center"><h3><%=uList.get(i).getUsername() %></h3></div></td>
	  		<td><div align="center"><h3><%=uList.get(i).getFirstname() %></h3></div></td>
	  		<td><div align="center"><h3><%=uList.get(i).getLastname() %></h3></div></td>
