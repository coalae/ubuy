...
<html lang="en">
<head>
<% String keywordToSearch = (String) request.getAttribute("keywordToSearch") ;%>
	<meta charset="UTF-8">
...
<br><br><br><br><br><br><br><br><br><br><br><br>
			<div align="center">
					<h2>All Auctions containing Keyword <% out.println(" " + keywordToSearch); %></h2> 
					<h3> Please click on the AuctionId Hyperlink to View the respective Auction</h3>
<br> 
<br>
<% AuctionManagement am = new AuctionManagement();
	ArrayList<Auction> allInclKeyword = am.searchAuctionByKeyword(keywordToSearch);%>
	<br><br>
	<table class="table table-striped">
	 ...
	 <%for(int i = 0; i<allInclKeyword.size(); i++){%>
	  	<tr>	  	
	  		<td><div align="center"><h3><a href="ViewThisAuctionServlet?param1=<%=allInclKeyword.get(i).getId()%>"> View this auction <%// =allInclKeyword.get(i).getId()%></a></h3></div></td>    
	  		<td><div align="center"><h3><%=allInclKeyword.get(i).getTitle() %></h3></div></td>
	  		<td><div align="center"><h3><%=allInclKeyword.get(i).getDescription() %></h3></div></td>
	  		<td><div align="center"><h3><%=allInclKeyword.get(i).getStartPrice() %></h3></div></td>
	  		<td><div align="center"><h3><%=am.getHighestBidAmount(allInclKeyword.get(i)) %></h3></div></td>
	  		<td><div align="center"><h3><%=allInclKeyword.get(i).getAuctionGroup() %></h3></div></td>
	  		<td><div align="center"><h3><%=am.auctionDaysLeft(allInclKeyword.get(i)) %></h3></div></td>
     	</tr>
	<%}%>
	</table>
