...
<html lang="en">
<head>
<% String categoryToSearch = (String) request.getAttribute("categoryToSearch") ;%>
	<meta charset="UTF-8">
	<title>uBuy Search Auction by Category</title>
					  ...
					  <div class="container-fluid nav-bar">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					      ...
					      <ul class="nav navbar-nav navbar-right">
					        ...
					        <li><a class="menu active" href="SearchAuctionByCategoryServlet">Search by Category</a></li>
...
<br><br><br><br><br><br><br><br><br><br><br><br>
			<div align="center">
					<h2>All Auctions in Category <% out.println(" " + categoryToSearch); %></h2> 
					<h3> Please click on the AuctionId Hyperlink to View the respective Auction</h3>
<br> 
<br>
<br><br>
<% AuctionManagement am = new AuctionManagement();
	ArrayList<Auction> allInCategory = am.searchAuctionByCategory(categoryToSearch);%>
	...
	<table class="table table-striped">
	 ...
	 <%for(int i = 0; i<allInCategory.size(); i++){%>
	  	<tr>	  		  	
	  		<td><div align="center"><h3><a href="ViewThisAuctionServlet?param1=<%=allInCategory.get(i).getId()%>"> View this auction <%// =allInCategory.get(i).getId()%></a></h3></div></td>    
	  		<td><div align="center"><h3><%=allInCategory.get(i).getTitle() %></h3></div></td>
	  		<td><div align="center"><h3><%=allInCategory.get(i).getDescription() %></h3></div></td>
	  		<td><div align="center"><h3><%=allInCategory.get(i).getStartPrice() %></h3></div></td>
	  		<td><div align="center"><h3><%=am.getHighestBidAmount(allInCategory.get(i)) %></h3></div></td>
	  		<td><div align="center"><h3><%=allInCategory.get(i).getAuctionGroup() %></h3></div></td>
	  		<td><div align="center"><h3><%=am.auctionDaysLeft(allInCategory.get(i)) %></h3></div></td>
	  	</tr>
	<%}%>
	</table>
