					...
					<nav class="navbar navbar-default">
					  <div class="container-fluid nav-bar">
						...
						<%if (user != null  &&  user.getUsertype()==0 && user.isActive()) {%>										     
					        <li><a class="menu active" href="AddAuctionServlet"> Add Auction</a></li>
...
<%AuctionManagement am = new AuctionManagement();%>
			...
			<div align="center">
					<form action="AddAuctionServlet" Method="POST" >
						  ...
						  <h4> End Date:</h4>  
						  <input type="text" name="enddatum" id="datepicker" required = "required">
						  <br>
						  
						  <br><br>
						  <h4> Auction Group:</h4>  
						  <select name="auctiongroup">
  						  <option value="Lernmaterial">Lernmaterial</option>
						  ...
						  <h4> Start Price:</h4>  
						  <input type="number" min = "0" step="0.01" name="startprice" required = "required">
						  <br>
						  
						  <br>
						  <input type="submit" value="Add Auction">
						  <input type="hidden" name="createdByUserUID" value="<%=user.getId()%>">
