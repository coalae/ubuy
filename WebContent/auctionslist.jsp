...
<br><br><br><br><br>
			<div align="center">
					<form action="AuctionsListServlet2" Method="GET" >
					<br><br><br><br><br><br> 
			    		  <h3> Please click to view ALL ACTIVE AUCTIONS:</h3>	
			    		  <br>
						  <input type="submit" value="View All Active Auctions">
					</form>
					
					<br><br> 
					<img src="img/onlineauction.jpg" alt="onlineauction" style="width:350px;height:200px;">
					<br><br>
					<br><br>
			</div>
