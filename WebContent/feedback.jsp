...
<!-- ====================================================
	...
	<% 
	ArrayList<Message> feedbackList = (ArrayList<Message>) request.getAttribute("messageList");
	if (user != null && user.getUsertype()==1 && user.isActive() && feedbackList!=null) { %>
	
	<div align = "center">
	<h1>Feedback Messages</h1> <br><br>
	</div>
	
	<div align = "right">
	<h3><a href="InboxServlet">Inbox</a>  
	&nbsp;&nbsp;|&nbsp;&nbsp; 
		...
		%>
			<tr>
				<%if (message.isRead()) {%>
					...
					<td><a href="ShowMessageServlet?messageId=<%=message.getId()%>&origin=fb"><%=message.getSubject() %></a></td>
				...
				<%} else { %>
					...
					<td><a href="ShowMessageServlet?messageId=<%=message.getId()%>&origin=fb"><b><%=message.getSubject() %></b></a></td>
	...
	<%}  //Ende: if (user!=null && user.getUsertype()==1 && user.isActive() && feedbackList!=null)
	else {
