...
<!-- ====================================================
	...
	if (user!=null && user.isActive() && reportedUsername!=null) {
	%>
	
	<div align="center">
	<h1>User Report</h1></div>
	<h3>Reporting User: <%=reportedUsername %></h3>
	<form action="ReportUserServlet" method="POST">
		<h3>Please explain why you wish to report this User:</h3>
		...
		<input type="hidden" name="reportedUsername" value="<%=reportedUsername%>">
	...
	<%} //Ende: if (user!=null && user.isActive() && reportedUsername!=null)
	else {
